...
const MATCH_INFO: Record<string, Array<{stadium: string; city: string; time: string; date: string}>> = {
  A: [
    ...
    {stadium:'Estadio Akron',city:'Guadalajara',time:'21:00',date:'11 Jun'},
  ...
  D: [
    {stadium:'SoFi Stadium',city:'Los Angeles',time:'12:00',date:'12 Jun'},
    {stadium:'Arrowhead Stadium',city:'Kansas City',time:'18:00',date:'12 Jun'},
    {stadium:'Lumen Field',city:'Seattle',time:'15:00',date:'17 Jun'},
    {stadium:'SoFi Stadium',city:'Los Angeles',time:'21:00',date:'17 Jun'},
    {stadium:'AT&T Stadium',city:'Dallas',time:'18:00',date:'25 Jun'},
    {stadium:'Lumen Field',city:'Seattle',time:'18:00',date:'25 Jun'},
  ],
  E: [
    {stadium:'Empower Field',city:'Denver',time:'21:00',date:'13 Jun'},
    {stadium:'Allianz Field',city:'Minneapolis',time:'18:00',date:'14 Jun'},
    {stadium:'MetLife Stadium',city:'Nueva Jersey',time:'21:00',date:'19 Jun'},
    {stadium:'Empower Field',city:'Denver',time:'21:00',date:'20 Jun'},
    {stadium:'MetLife Stadium',city:'Nueva Jersey',time:'21:00',date:'25 Jun'},
    {stadium:'NRG Stadium',city:'Houston',time:'21:00',date:'25 Jun'},
  ],
  F: [
    {stadium:'Levis Stadium',city:'Santa Clara',time:'18:00',date:'14 Jun'},
    {stadium:'Rose Bowl',city:'Pasadena',time:'21:00',date:'14 Jun'},
    {stadium:'Rose Bowl',city:'Pasadena',time:'18:00',date:'20 Jun'},
    {stadium:'Levis Stadium',city:'Santa Clara',time:'21:00',date:'20 Jun'},
    {stadium:'Rose Bowl',city:'Pasadena',time:'18:00',date:'25 Jun'},
    {stadium:'Levis Stadium',city:'Santa Clara',time:'18:00',date:'25 Jun'},
  ],
  G: [
    {stadium:'AT&T Stadium',city:'Dallas',time:'21:00',date:'14 Jun'},
    {stadium:'Gillette Stadium',city:'Boston',time:'18:00',date:'15 Jun'},
    {stadium:'Arrowhead Stadium',city:'Kansas City',time:'21:00',date:'20 Jun'},
    {stadium:'Hard Rock Stadium',city:'Miami',time:'18:00',date:'21 Jun'},
    {stadium:'Hard Rock Stadium',city:'Miami',time:'18:00',date:'26 Jun'},
    {stadium:'Arrowhead Stadium',city:'Kansas City',time:'18:00',date:'26 Jun'},
  ],
  H: [
    {stadium:'Mercedes-Benz Stadium',city:'Atlanta',time:'12:00',date:'15 Jun'},
    {stadium:'Estadio BBVA',city:'Monterrey',time:'18:00',date:'15 Jun'},
    {stadium:'Mercedes-Benz Stadium',city:'Atlanta',time:'12:00',date:'21 Jun'},
    {stadium:'Estadio BBVA',city:'Monterrey',time:'21:00',date:'21 Jun'},
    {stadium:'Estadio Akron',city:'Guadalajara',time:'18:00',date:'26 Jun'},
    {stadium:'Estadio Akron',city:'Guadalajara',time:'18:00',date:'26 Jun'},
  ],
  I: [
    {stadium:'MetLife Stadium',city:'Nueva Jersey',time:'15:00',date:'16 Jun'},
    {stadium:'Lincoln Financial Field',city:'Filadelfia',time:'18:00',date:'16 Jun'},
    {stadium:'MetLife Stadium',city:'Nueva Jersey',time:'15:00',date:'22 Jun'},
    {stadium:'Lincoln Financial Field',city:'Filadelfia',time:'20:00',date:'22 Jun'},
    {stadium:'NRG Stadium',city:'Houston',time:'18:00',date:'26 Jun'},
    {stadium:'NRG Stadium',city:'Houston',time:'18:00',date:'26 Jun'},
  ],
  J: [
    {stadium:'Estadio BBVA',city:'Monterrey',time:'21:00',date:'15 Jun'},
    {stadium:'Estadio Akron',city:'Guadalajara',time:'18:00',date:'16 Jun'},
    {stadium:'Estadio BBVA',city:'Monterrey',time:'21:00',date:'21 Jun'},
    {stadium:'Estadio Akron',city:'Guadalajara',time:'18:00',date:'22 Jun'},
    {stadium:'Estadio Azteca',city:'Ciudad de Mexico',time:'21:00',date:'27 Jun'},
    {stadium:'Estadio Azteca',city:'Ciudad de Mexico',time:'21:00',date:'27 Jun'},
  ],
  K: [
    {stadium:'NRG Stadium',city:'Houston',time:'15:00',date:'16 Jun'},
    {stadium:'Empower Field',city:'Denver',time:'18:00',date:'16 Jun'},
    {stadium:'Empower Field',city:'Denver',time:'21:00',date:'22 Jun'},
    {stadium:'NRG Stadium',city:'Houston',time:'18:00',date:'22 Jun'},
    {stadium:'Arrowhead Stadium',city:'Kansas City',time:'18:00',date:'27 Jun'},
    {stadium:'Arrowhead Stadium',city:'Kansas City',time:'18:00',date:'27 Jun'},
  ],
  L: [
    {stadium:'BMO Field',city:'Toronto',time:'18:00',date:'17 Jun'},
    {stadium:'Commonwealth Stadium',city:'Edmonton',time:'21:00',date:'17 Jun'},
    {stadium:'BMO Field',city:'Toronto',time:'18:00',date:'22 Jun'},
    {stadium:'Commonwealth Stadium',city:'Edmonton',time:'21:00',date:'23 Jun'},
    {stadium:'BC Place',city:'Vancouver',time:'18:00',date:'27 Jun'},
    {stadium:'BC Place',city:'Vancouver',time:'18:00',date:'27 Jun'},
  ],
}
