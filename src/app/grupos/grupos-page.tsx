...
```
  ...
  <div style={{ marginBottom: 24 }}>
    ...
    {!locked && (
      <div style={{ marginTop: 10, background: 'rgba(255,255,255,0.05)', borderRadius: 10, height: 6, overflow: 'hidden' }}>
        <div style={{ height: '100%', background: 'linear-gradient(90deg, var(--gold), var(--nike-red))', borderRadius: 10, width: `${(totalDone / totalMatches) * 100}%`, transition: 'width 0.4s' }} />
      </div>
    )}
  ...
  <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
    {[{ pts: '3pts', label: 'Resultado exacto', c: 'var(--gold)' }, { pts: '1pt', label: 'Ganador/empate', c: 'var(--blue)' }].map(s => (
      <div key={s.pts} style={{ background: 'rgba(17,17,24,0.7)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 8, padding: '5px 12px', fontSize: '0.78rem', display: 'flex', gap: 8, alignItems: 'center', backdropFilter: 'blur(10px)' }}>
      ...
      <div key={match.id} style={{ marginBottom: 16 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            ...
            {pts !== null && (
              <span style={{
                fontFamily: "'Bebas Neue', sans-serif", fontSize: '0.85rem', padding: '2px 8px', borderRadius: 5,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
          ...
          <div style={{
            background: pts !== null
              ? pts === 3 ? 'rgba(244,197,66,0.05)' : pts === 1 ? 'rgba(59,130,246,0.05)' : 'rgba(214,40,40,0.04)'
              : 'rgba(17,17,24,0.75)',
          ...
          {/* RESULTADO REAL */}
          <div style={{
            background: res ? 'rgba(244,197,66,0.05)' : 'rgba(17,17,24,0.75)',
            border: `1px solid ${res ? 'rgba(244,197,66,0.2)' : 'rgba(255,255,255,0.07)'}`,
            borderTop: 'none',
