    ...
    <div style={{ maxWidth: 960, margin: '0 auto', padding: '32px 20px 60px' }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '0.85rem', marginTop: 4 }}>
          Hola <strong style={{ color: 'var(--text)' }}>{player.username}</strong> — Tus predicciones se guardan automaticamente
        </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 10, padding: '0 4px' }}>
        <div style={{ fontSize: '0.72rem', color: 'var(--muted)', letterSpacing: '0.15em', textTransform: 'uppercase', textAlign: 'center' }}>Tu Prediccion</div>
        ...
        return (
          <div key={match.id} style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
              <div style={{ background: 'var(--dark3)', border: `1px solid ${cardBorder}`, borderRadius: 14, padding: '14px 12px' }}>
              ...
              <div style={{ background: res ? 'rgba(244,197,66,0.04)' : 'var(--dark3)', border: `1px solid ${res ? 'rgba(244,197,66,0.25)' : 'var(--border)'}`, borderRadius: 14, padding: '14px 12px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                {res ? (
