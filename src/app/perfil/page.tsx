...
const SoccerIcon = () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/></svg>
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ background: 'rgba(10,10,16,0.8)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '18px', marginBottom: 16, backdropFilter: 'blur(12px)' }}>
            ...
            {predPct < 100 && (
              <Link href="/grupos" style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: '0.75rem', color: 'var(--gold)' }}>
                Completar predicciones <ChevronIcon />
              </Link>
            )}
          </div>
