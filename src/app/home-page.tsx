...
```
  ...
  <h1 style={{
    ...
    textShadow: 'none',
    filter: 'drop-shadow(0 0 40px rgba(244,197,66,0.3))',
  }}>
  ...
  {player ? (
    <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
      <Link href="/grupos" style={{ background: 'linear-gradient(135deg, var(--gold), var(--nike-red))', color: '#fff', borderRadius: 12, padding: '14px 32px', fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.2rem', letterSpacing: '0.08em', boxShadow: '0 4px 24px rgba(244,197,66,0.3)' }}>
        Ir a Grupos
      </Link>
    ...
    <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
      <Link href="/login" style={{ background: 'linear-gradient(135deg, var(--gold), var(--nike-red))', color: '#fff', borderRadius: 12, padding: '14px 32px', fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.2rem', letterSpacing: '0.08em', boxShadow: '0 4px 24px rgba(244,197,66,0.3)' }}>
